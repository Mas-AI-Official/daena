  ...
  const commands: SlashCommand[] = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: DollarSign,
        action: () => toast.info('Cost tracking: coming in next release'),
      },
      {
        command: '/clear',
        description: 'Clear chat history',
        icon: Trash2,
        action: () => toast.info('Use the new session button to start fresh'),
      },
      {
        command: '/export',
        description: 'Export conversation',
        icon: Download,
        action: () => toast.info('Export: coming in next release'),
      },
      {
        command: '/compact',
        description: 'Toggle compact message view',
        icon: Minimize2,
        action: () => toast.info('Compact mode: coming in next release'),
      },
      {
        command: '/marketplace',
        description: 'Open skills/plugins marketplace',
        icon: Store,
        action: () => navigate('/settings/daenabot'),
      },
      {
        command: '/memory',
