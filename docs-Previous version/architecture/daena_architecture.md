...
**Five Specialized Councils** enhanced with **Leadership Inspiration Profiles:**
...
**Leadership Inspiration Profiles** influence council decisions through configurable weightings:

- **Visionary Strategy**: Long-horizon thinking, bold bets, platform leverage
- **Ethical AI**: Safety-first approach, responsible governance, fairness
- **Operational Excellence**: Cost efficiency, reliability, throughput optimization
- **Customer Obsession**: User-first mindset, experience excellence
- **Product Craft**: Quality excellence, attention to detail, elegant solutions
- **Data-Driven**: Evidence-based decisions, metrics-driven approach
- **Agile Innovation**: Rapid iteration, fail-fast mentality, adaptability
- **Security First**: Security by design, risk management, threat modeling

**Profile Configuration:**
- Founder selects 1-N profiles per council/department
- Adjustable weights per profile (0.0-1.0)
- All changes logged for governance
- External sharing supports anonymization ("Profile A", "Profile B")

**Files:**
- `config/councils.yaml`: Profile definitions and selections
- `policies/council_profiles.py`: Inspiration vector computation
- `policies/council_vote.py`: Enhanced voting with profile bias
