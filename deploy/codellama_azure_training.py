#!/usr/bin/env python3
"""
Azure GPU Training Script for codellama
"""
...
def train_codellama_on_azure():
    ...
    # Load training data
    with open("./data/codellama_training_data.json", 'r') as f:
    ...
    training_args = TrainingArguments(
        output_dir="./trained_models/codellama_azure",
        num_train_epochs=3,
