#!/usr/bin/env python3
"""
Azure GPU Training Script for deepseek_moe
"""
...
def train_deepseek_moe_on_azure():
    # Load model
    ...
    # Load training data
    with open("./data/deepseek_moe_training_data.json", 'r') as f:
    ...
    training_args = TrainingArguments(
        output_dir="./trained_models/deepseek_moe_azure",
        num_train_epochs=3,
