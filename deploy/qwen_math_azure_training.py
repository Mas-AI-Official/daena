#!/usr/bin/env python3
"""
Azure GPU Training Script for qwen_math
"""
...
def train_qwen_math_on_azure():
    ...
    # Load training data
    with open("./data/qwen_math_training_data.json", 'r') as f:
    ...
    training_args = TrainingArguments(
        output_dir="./trained_models/qwen_math_azure",
        num_train_epochs=3,
