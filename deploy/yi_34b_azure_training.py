#!/usr/bin/env python3
"""
Azure GPU Training Script for yi_34b
"""
...
def train_yi_34b_on_azure():
    ...
    training_args = TrainingArguments(
        output_dir="./trained_models/yi_34b_azure",
        num_train_epochs=3,
