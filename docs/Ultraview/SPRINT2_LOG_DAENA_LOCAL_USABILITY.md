...
| 4 | PR-LOCAL-DAENA-USABILITY-SMOKE | shipped | (next commit) | live smoke run | every backend section PASS; visual sections deferred to operator |
...
- 20:18 | PR-4 | (next)  | local usability smoke run + status doc -- every backend section PASS, 10 promoted skills confirmed live, sprint COMPLETE
