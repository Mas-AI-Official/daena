...
echo [DAENA BACKEND] Provider onboarding: http://127.0.0.1:%PORT%/ui/provider-onboarding
echo [DAENA BACKEND] Control plane: App Setup /ui/app-setup then Integrations/Skills/Execution/Proactive/Tasks/Approvals
echo [DAENA BACKEND] Set EXECUTION_TOKEN in env; save token in Dashboard Execution panel (syncs to Skills/Execution/Tasks/Approvals)
echo [DAENA BACKEND] UI wiring audit: /ui/wiring-audit
